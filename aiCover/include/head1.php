                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            ...
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="./home.php">HOME<input type="hidden" value="<?php echo $id; ?>"></a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="productlist.php">PRODUCTS</a></li>
                                <li <?php echo $style; ?> class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="report.php">REPORT</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="receipt.php">CART <span class="badge badge-dark"><?php echo count($_SESSION['arr']); ?></span></a></li>
                                <li class="js_nav-item nav-item dropdown"><a class="nav-item-child nav-item-hover" href="#"><?php echo $_SESSION['username'];?> &nbsp;<i class="glyphicon glyphicon-user"></i></a>
                                <div class="dropdown-content">
                                    <a href="dropship.php?user=<?php echo $id; ?>">MY ACCOUNT</a>
                                    <?php echo $show; ?>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active ">
                    <img class="img-responsive blur" src="image/B3.PNG" alt="Slider Image">
                    <div class="container">
