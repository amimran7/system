...
$sqllist="SELECT p.pk_product,p.procode,p.proname,p.category,u.`code`,p.design,p.color,r.`year`,r.`month`,p.size,p.material,c.category,d.design,l.color,s.size,m.material,o.priceA,o.priceD,o.quantity,o.priceN,p.priceA AS tA,p.priceD AS tD,o.price1,r.dcreate, SUM(r.wages), SUM(r.profit)
FROM product p
...
.form-control:-ms-input-placeholder {
    ...
    <body>
        ...
        <form action="ordrep.php" method="post" style="margin:30px 0px 10px 0px">
        ...
        <h2> <img src="../image/logo.PNG"><br> ORDER LIST REPORT</h2>
        ...
        <table class="table table-bordered table-striped col-lg-12 col-sm-12">
            <thead>
                <tr>
                    <th>No</th><th>Product Code</th><th>Product Name</th><th>Quantity</th><th class="hid">Agent Price </th><th>Dropshipper Price</th><th>Customer Price</th><th class="hid">Wages</th><th>Profit</th>
                </tr>
            </thead>
            <tbody>
                <?php
                $bil=1; $profit=0; $wages=0;
                 while($row2=mysqli_fetch_array($reslist)){
                ...
                <tr>
                    ...
                    <td><?php echo $bil++; ?></td>                                 
                                 ...
                                 <td>RM <?php echo $t1=$row2['priceN']-$row2['priceD']; ?></td>
                                 <td>RM <?php echo $t2=$row2['priceD']-$row2['priceA']; ?></td>
                ...
                <?php
                    ...
                    ?>
                <tr>
                    <td colspan="7">TOTAL</td><td><b>RM <?php echo $wages; ?></b></td><td><b>RM <?php echo $profit; ?></b></td>
                </tr>
            </tbody>
        </table>
