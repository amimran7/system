...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <a class="btn-theme btn-theme-sm btn-white-bg text-uppercase dontprint" onClick="print()" >
...
<div class="col-md-11" id="chartContainer" style="height: 370px; margin:20px;"></div>
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-striped box col-md-12" id="individu">
            <thead class="">
                <tr>
                    <th>No</th><th>Receipt Code</th><th>Client Name</th><th>Date</th><th>Total</th><th>Receipt Number</th><th>Wages</th><th class="hid">Profit</th>
                </tr>
            </thead>
            <tbody>
                <?php 
