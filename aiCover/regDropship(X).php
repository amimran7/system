...
<div class="row">
  ...
  <li class="active"><a href="#">Register Dropshipper</a></li>
...
<form class="well form-horizontal col-lg-10" action="act_regDropship.php" method="post"  id="contact_form" enctype="multipart/form-data">
<fieldset>
...
<div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">        
        <input name=fname placeholder="Full Name" class="form-control form"  type="text">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">        
        <input name="username" placeholder="Username" class="form-control form"  type="text">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">        
        <input name="id" placeholder="Identification Number" class="form-control form"  type="text">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">        
        <textarea name="address" placeholder="Address" class="form-control form" cols="5" rows="2"></textarea>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">        
        <input name="notel" placeholder="Phone Number" class="form-control form"  type="text">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">        
        <input name="smedia" placeholder="Media type(Account Name),..." class="form-control form"  type="text">
    </div>
</div>
